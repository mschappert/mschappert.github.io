...
const resources = [
  ...
  ['geojson.io', 'Draw, edit, and share GeoJSON features directly in a web map.', 'Tool', 'https://geojson.io/?map=1.81/34.96753/-10.91896'],
  ['Source Cooperative', 'A community platform for publishing and accessing open geospatial data.', 'Data', 'https://source.coop/'],
  ['Protected Planet', 'Global data and maps for protected and conserved areas.', 'Data', 'https://www.protectedplanet.net/en'],
  ['IBGE Environmental Studies', 'Brazilian Institute of Geography and Statistics environmental studies and geospatial information.', 'Data', 'https://www.ibge.gov.br/en/geosciences/environmental-information/environmental-studies.html'],
  ['USGS ScienceBase Dataset', 'A USGS ScienceBase catalog record for downloadable scientific and geospatial data.', 'Data', 'https://www.sciencebase.gov/catalog/item/6296791ed34ec53d276bb293'],
  ['geoBoundaries', 'Open global administrative boundary data for countries and subnational units.', 'Data', 'https://www.geoboundaries.org/'],
  ['EPA AirData', 'Downloadable U.S. air-quality monitoring data from the Environmental Protection Agency.', 'Data', 'https://aqs.epa.gov/aqsweb/airdata/download_files.html'],
  ['USGS EarthExplorer', 'Search and download satellite imagery, aerial photography, and other Earth-observation data.', 'Tool', 'https://earthexplorer.usgs.gov/'],
  ['Geofabrik OpenStreetMap Downloads', 'Regional OpenStreetMap extracts ready for GIS analysis.', 'Data', 'https://download.geofabrik.de/'],
  ['GHSL Settlement Model', 'Global Human Settlement Layer settlement-model data available through Google Earth Engine.', 'Data', 'https://developers.google.com/earth-engine/datasets/catalog/JRC_GHSL_P2023A_GHS_SMOD_V2-0#bands'],
  ['GLAD GEDI Dataset', 'GEDI lidar-derived forest structure data and related Global Land Analysis and Discovery resources.', 'Data', 'https://glad.umd.edu/dataset/gedi'],
  ['Zenodo Record 4974336', 'A citable open dataset record hosted by Zenodo.', 'Data', 'https://zenodo.org/records/4974336'],
  ['Animal Tracking and Remote Sensing', 'NASA Earthdata training on integrating animal-tracking data with remote sensing.', 'Training', 'https://www.earthdata.nasa.gov/learn/trainings/introduction-integration-animal-tracking-remote-sensing'],
  ['GBIF', 'Global biodiversity occurrence data from museums, herbaria, research projects, and citizen science.', 'Data', 'https://www.gbif.org/'],
  ['GHSL Population Data', 'Global Human Settlement Layer population datasets for settlement and exposure analysis.', 'Data', 'https://human-settlement.emergency.copernicus.eu/download.php?ds=pop'],
  ['OpenStreetMap Planet', 'The complete downloadable OpenStreetMap database.', 'Data', 'https://planet.openstreetmap.org/'],
  ['Global Forest Change Explorer — Atlantic Forest', 'Interactive Global Forest Change map centered on the Atlantic Forest.', 'Tool', 'https://glad.earthengine.app/view/global-forest-change#bl=off;old=off;dl=1;lon=-49.71913520365347;lat=-23.44042842845067;zoom=5;'],
  ['Global Forest Disturbance Types', 'Dataset of major global forest disturbance types between 2000 and 2020.', 'Data', 'https://figshare.com/articles/dataset/Global_forest_main_disturbance_types_between_2000_and_2020/28465178'],
  ['Global Forest Change Explorer — Global', 'Interactive global map of tree-cover loss, gain, and forest change.', 'Tool', 'https://glad.earthengine.app/view/global-forest-change#bl=off;old=off;dl=5;lon=-87.03722402138689;lat=-15.622952643615852;zoom=3;'],
  ['GLOBIO GRIP Dataset', 'Global Roads Inventory Project data for mapping road infrastructure and fragmentation.', 'Data', 'https://www.globio.info/download-grip-dataset'],
  ['USDA Web Soil Survey', 'Interactive access to U.S. soil maps and soil-survey data.', 'Tool', 'https://websoilsurvey.nrcs.usda.gov/app/'],
  ['NASA CSDAP', 'Climate and Societal Dimensions of Earth System Data and Applications Program resources.', 'Training', 'https://csdap.earthdata.nasa.gov/'],
  ['Natural Earth', 'Public-domain global cultural, physical, and raster map data.', 'Data', 'https://www.naturalearthdata.com/'],
  ['GADM', 'Global administrative boundary datasets for countries and subnational areas.', 'Data', 'https://gadm.org/index.html']
